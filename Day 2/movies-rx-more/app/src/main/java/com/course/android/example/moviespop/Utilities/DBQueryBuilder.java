...
public class DBQueryBuilder {
    ...
    protected Map<String, String> mProjection = new TreeMap<String, String>();

    protected StringBuilder mSelection = new StringBuilder();
    protected ArrayList<String> mSelectionArgs = new ArrayList<String>();
    ...
    public Cursor query(SQLiteDatabase db, boolean distinct,
        ...
        return db.query(distinct, mTable, columns, getSelection(),
                getSelectionArgs(), null, null, orderBy, limit);
    }
